function [name2CH, info2CH, read_flag2CH, filepath2CH, dataC2CH, data12CH, data12CH_ctr, sum_map, ...
    save_default_name, info, read_flag, filepath, dataC, data1, px_size, px_flag, ring_diameter] = ...
        readfilext(ch_coloc, read_image_flag, ch_tal, ring_diameter_um, name2CH, info2CH, read_flag2CH, ...
        filepath2CH, dataC2CH, data12CH, data12CH_ctr, sum_map, save_default_name, info, read_flag, ...
        filepath, dataC, data1, px_size, px_flag, ring_diameter, FA, colocalization, px_size_flag)
    ...
    try
        if ~read_image_flag
            ...
            if colocalization && any(ch_coloc == ch_tal)
                ...
                [px_size, px_flag, ring_diameter] = talReadPxSize(info, px_size, px_flag, px_size_flag, ...
